    ...
    fn key_alg(&self) -> KnownKeyAlg {
        match (&self.type_, &self.verification_material) {
            ...
            (
                ...
                VerificationMaterial::PublicKeyBase58 { value: _ },
            ) => KnownKeyAlg::X25519,
            (
            ...
            (
                ...
                VerificationMaterial::PublicKeyMultibase { value: _ },
            ) => KnownKeyAlg::X25519,
            (
...
mod tests {
    ...
    fn verification_method_as_key_pair_x25519_2019_base58_works() {
        let actual_key = VerificationMethod {
            ...
            verification_material: (VerificationMaterial::PublicKeyBase58 { value: "JhNWeSVLMYccCk7iopQW4guaSJTojqpMEELgSLhKwRr".to_string() }),
        }
        .as_key_pair()
        .unwrap();
    ...
    fn verification_method_as_key_pair_ed25519_2018_base58_works() {
        let actual_key = VerificationMethod {
            ...
            verification_material: (VerificationMaterial::PublicKeyBase58 { value: "ByHnpUCFb1vAfh9CFZ8ZkmUZguURW8nSw889hy6rD8L7".to_string() }),
        }
        .as_key_pair()
        .unwrap();
    ...
    fn verification_method_as_key_pair_x25519_2020_multibase_works() {
        let actual_key = VerificationMethod {
            ...
            controller: "did:example:eve#key-x25519-1".to_string(),
            verification_material: (VerificationMaterial::PublicKeyMultibase { value: "z6LSbysY2xFMRpGMhb7tFTLMpeuPRaqaWM1yECx2AtzE3KCc".to_string() }),
        }
        .as_key_pair()
        .unwrap();
    ...
    fn verification_method_as_key_pair_ed25519_2020_multibase_works() {
        let actual_key = VerificationMethod {
            ...
            controller: "did:example:eve#key-ed25519-1".to_string(),
            verification_material: (VerificationMaterial::PublicKeyMultibase { value: "z6MkqRYqQiSgvZQdnBytw86Qbs2ZWUkGv22od935YF4s8M7V".to_string() }),
        }
        .as_key_pair()
        .unwrap();
