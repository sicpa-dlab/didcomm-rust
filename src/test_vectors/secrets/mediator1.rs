...
lazy_static! {
    ...
    pub static ref MEDIATOR1_SECRET_KEY_AGREEMENT_KEY_P256_1: Secret = Secret {
    ...
    pub static ref MEDIATOR1_SECRET_KEY_AGREEMENT_KEY_P384_1: Secret = Secret {
    ...
    pub static ref MEDIATOR1_SECRET_KEY_AGREEMENT_KEY_P521_1: Secret = Secret {
