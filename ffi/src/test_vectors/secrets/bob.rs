...
lazy_static! {
    ...
    &Secret {
        ...
        secret_material: SecretMaterial::JWK{value: json!(
        {
            "kty": "OKP",
    ...
    pub(crate) static ref BOB_SECRET_KEY_AGREEMENT_KEY_X25519_3: String =
    serde_json::to_string(
    &Secret {
    ...
    pub(crate) static ref BOB_SECRET_KEY_AGREEMENT_KEY_P256_2: String =
    serde_json::to_string(
    &Secret {
    ...
    pub(crate) static ref BOB_SECRET_KEY_AGREEMENT_KEY_P521_1: String =
    serde_json::to_string(
    &Secret {
    ...
    pub(crate) static ref BOB_SECRETS: Vec<String> = vec![
